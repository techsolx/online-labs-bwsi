...
def coordinates():
    ...
    def show_coords(x, y):
        ...
        cv2.putText(
            img, "Point: " + str((x, y)), (220, 480), 0, 0.75, (255, 255, 255), 2
        )
...
def hsv_select(filename):
    ...
    def callback(value):
        ...
        cv2.putText(
            img_masked,
            "HSV Lower: {}".format(tuple(hsv_min)),
            (10, 35),
            0,
            0.75,
            (255, 255, 255),
        ...
        cv2.putText(
            img_masked,
            "HSV Upper: {}".format(tuple(hsv_max)),
            (10, 70),
            0,
            0.75,
            (255, 255, 255),
...
def draw_matches(img, frame, total_keypoints, matches, kp_img, kp_frame):
    ...
    img_matches = cv2.drawMatchesKnn(
        img, kp_img, frame, kp_frame, matches, None, **draw_params
    )
